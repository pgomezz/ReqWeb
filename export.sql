...
Insert into ALTRANREQ_USER (ID_USER,NAME,PASSWORD,USERNAME,EMAIL,MOBILE,IS_ADMIN,AGE,ADDRESS,CITY,ZIP_CODE) values (6,'x','∷靎$�9�1劤勋� �畫','x','x','1','0',null,null,null,null);
...
Insert into ALTRANREQ_USER (ID_USER,NAME,PASSWORD,USERNAME,EMAIL,MOBILE,IS_ADMIN,AGE,ADDRESS,CITY,ZIP_CODE) values (9,'admin','∷靎$�9�1劤勋� �畫','admin','admin','1','1',1,'1','1','1');
...
SET DEFINE OFF;
Insert into BUSINESS_CATEGORY (ID_BUSINESS_CATEGORY,NAME) values (97,'Engenharia Mec鈔ica');
Insert into BUSINESS_CATEGORY (ID_BUSINESS_CATEGORY,NAME) values (71,'Ind鷖tria');
...
SET DEFINE OFF;
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (1,'Acesso 醨ea Administra玢o e gest鉶 de utilizadores');
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (2,'Acesso 醨ea de Gest鉶 de Organiza珲es');
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (3,'Acesso 醨ea Gest鉶 do Projecto');
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (4,'Acessos 醨ea Gest鉶 requisitos funcionais');
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (5,'Acessos 醨ea Gest鉶 requisitos n鉶 funcionais');
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (6,'Acessos 醨ea Gest鉶 casos de uso');
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (7,'Acessos 醨ea Gest鉶 requisitos t閏nicos');
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (8,'Criar, alterar e remover utilizadores');
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (9,'Atribui玢o do perfil de gestor de projecto');
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (10,'Atribui玢o do perfil de analista funcional');
...
Insert into PRIVILEGE (ID_PRIVILEGE,ACTION_NAME) values (15,'Criar, alterar e remover requisitos t閏nicos');
...
Insert into PROJECT (ID_PROJECT,NAME,BEGIN_DATE,END_DATE,PROJECT_STATE,ID_PROJECT_MANAGER,TERMINOLOGY,ID_ORGANIZATION) values (129,'teste remo莽茫o ningu茅m mexe',to_date('04-NOV-13','DD-MON-RR'),to_date('14-NOV-13','DD-MON-RR'),0,4,'ewdew',null);
